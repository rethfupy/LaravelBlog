    ...
    <footer class="edica-footer mt-4" data-aos="fade-up">
        <div class="container">
            ...
            <div class="footer-bottom-content">
                ...
                <p class="mb-0">© Edica. 2025 <a href="https://www.bootstrapdash.com" target="_blank" rel="noopener noreferrer" class="text-reset">bootstrapdash</a> . All rights reserved.</p>
            </div>
        </div>
    </footer>
